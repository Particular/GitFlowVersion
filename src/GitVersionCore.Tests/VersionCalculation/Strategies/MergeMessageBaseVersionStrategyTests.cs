...
namespace GitVersionCore.Tests.VersionCalculation.Strategies
{
    ...
    public class MergeMessageBaseVersionStrategyTests : TestBase
    {
        ...
        [TestCase("Merge branch 'Releases-0.2.0'", true, "0.2.0")]
        [TestCase("Merge branch 'Releases/0.2.0'", true, "0.2.0")]
        [TestCase("Merge branch 'Hotfix/0.2.0'", true, "0.2.0")]
        [TestCase("Merge branch 'Hotfixes/0.3.0' into support-2.0.0", true, "0.3.0")]
        [TestCase("Merge branch 'hotfix-0.5.0'", true, "0.5.0")]
        [TestCase("Merge branch 'hotfixes-8.0.0'", true, "8.0.0")]
        [TestCase("Merge branch 'hotfixes-8.0.0' into master", true, "8.0.0")]
        ...
        [TestCase("Merge branch 'Feature-0.1.5'", false)]
        ...
        [TestCase("Merge branch 'feature-0.1.5'\n\nRelates to: TicketId", true)]
